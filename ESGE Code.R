...
# Extract R-squared
fixest::fitstat(treatment_fe, "r2")
...
# 1. No FE
lpm_nofe_std_cat <- feols( CATHOLIC ~ childhood_total_dry_days_std  + FEMALE +
                        FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                        FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                        MOTHER_BORN_SPAIN,
                      data = model_data, cluster = ~birth_prov_cluster)
...
# 1. No FE
lpm_nofe_std_rel <- feols( RELIGIOUS_PRACTICE ~ childhood_total_dry_days_std  + FEMALE +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
...
# 1. No FE
lpm_nofe_std_cou <- feols( COUPLE_CATHOLIC ~ childhood_total_dry_days_std  + FEMALE +
                         FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                         FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                         MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                         MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_par <- feols( PARTICIPATION ~ childhood_total_dry_days_std  + FEMALE +
                         FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                         FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                         MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                         MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_con <- feols( CONSERVATIVE_VOTE ~ childhood_total_dry_days_std  + FEMALE +
                         FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                         FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                         MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                         MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_far <- feols( FAR_RIGHT_VOTE ~ childhood_total_dry_days_std  + FEMALE +
                         FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                         FATHER_EMPLOYMENT +
                         MOTHER_BORN_SPAIN + MOTHER_EDUCATION +
                         MOTHER_EMPLOYMENT,
...
# Load fixest package (you already use feols)
library(fixest)

# ---------------------------
# Logit: CATHOLIC
# ---------------------------
logit_nofe_cat <- feglm(CATHOLIC ~ childhood_total_dry_days_std + FEMALE +
                          FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                          FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                          MOTHER_BORN_SPAIN,
                        data = model_data, cluster = ~birth_prov_cluster,
...
logit_fe_cat <- update(logit_nofe_cat, . ~ . | BIRTH + prov_nac)

# ---------------------------
# Logit: practice (Religious practice dummy)
# ---------------------------
logit_nofe_practice <- feglm(practice ~ childhood_total_dry_days_std + FEMALE +
                               FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                               FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                               MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                               MOTHER_EMPLOYMENT,
...
logit_fe_practice <- update(logit_nofe_practice, . ~ . | BIRTH + prov_nac)

# ---------------------------
# Logit: COUPLE_CATHOLIC
# ---------------------------
logit_nofe_cou <- feglm(COUPLE_CATHOLIC ~ childhood_total_dry_days_std + FEMALE +
                          FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                          FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                          MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                          MOTHER_EMPLOYMENT,
...
logit_fe_cou <- update(logit_nofe_cou, . ~ . | BIRTH + prov_nac)
...
modelsummary(
  list(
    "Catholic (No FE)" = logit_nofe_cat,
    "Catholic (FE)" = logit_fe_cat,
    "Practice (No FE)" = logit_nofe_practice,
    "Practice (FE)" = logit_fe_practice,
    "Couple Catholic (No FE)" = logit_nofe_cou,
    "Couple Catholic (FE)" = logit_fe_cou
  ),
  title = "Logit: Catholic identification, religious practice and couple catholic",
  output = "latex",
  stars = c("*" = .1, "**" = .05, "***" = .01),
  coef_omit = "^(FATHER_|MOTHER_)",
  gof_omit = "AIC|BIC|R2 Within|R2 Within Adj."
...
# Logit: PARTICIPATION
# ---------------------------
logit_nofe_par <- feglm(PARTICIPATION ~ childhood_total_dry_days_std + FEMALE +
                          FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                          FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                          MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                          MOTHER_EMPLOYMENT,
...
logit_fe_par <- update(logit_nofe_par, . ~ . | BIRTH + prov_nac)

# ---------------------------
# Logit: CONSERVATIVE_VOTE
# ---------------------------
logit_nofe_con <- feglm(CONSERVATIVE_VOTE ~ childhood_total_dry_days_std + FEMALE +
                          FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                          FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                          MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                          MOTHER_EMPLOYMENT,
...
logit_fe_con <- update(logit_nofe_con, . ~ . | BIRTH + prov_nac)

# ---------------------------
# Logit: FAR_RIGHT_VOTE
# ---------------------------
logit_nofe_far <- feglm(FAR_RIGHT_VOTE ~ childhood_total_dry_days_std + FEMALE +
                          FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                          FATHER_EMPLOYMENT +
                          MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                          MOTHER_EMPLOYMENT,
...
logit_fe_far <- update(logit_nofe_far, . ~ . | BIRTH + prov_nac)

# ---------------------------
# Modelsummary: Participation, Conservative vote, Far-right vote
# ---------------------------
modelsummary(
  list(
    "Participation (No FE)" = logit_nofe_par,
    "Participation (FE)" = logit_fe_par,
    "Conservative (No FE)" = logit_nofe_con,
    "Conservative (FE)" = logit_fe_con,
    "Far-right (No FE)" = logit_nofe_far,
    "Far-right (FE)" = logit_fe_far
  ),
  title = "Logit: Probability of participation and voting for conservatives or far-right",
  output = "latex",
  stars = c("*" = .1, "**" = .05, "***" = .01),
  coef_omit = "^(FATHER_|MOTHER_)",
  gof_omit = "AIC|BIC|R2 Within|R2 Within Adj."
...
# Robustness check: CLUSTERING STANDARD ERRORS BY PROVINCE ----------------
...
# 1. No FE
lpm_nofe_std_cat <- feols( CATHOLIC ~ childhood_total_dry_days_std  + FEMALE + FEMALE:childhood_total_dry_days_std +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN,
                           data = model_data, cluster = ~birth_prov_cluster)
...
# 1. No FE
lpm_nofe_std_rel <- feols( RELIGIOUS_PRACTICE ~ childhood_total_dry_days_std  + FEMALE + FEMALE:childhood_total_dry_days_std +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_cou <- feols( COUPLE_CATHOLIC ~ childhood_total_dry_days_std  + FEMALE + FEMALE:childhood_total_dry_days_std +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_par <- feols( PARTICIPATION ~ childhood_total_dry_days_std  + FEMALE + FEMALE:childhood_total_dry_days_std +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_con <- feols( CONSERVATIVE_VOTE ~ childhood_total_dry_days_std  + FEMALE + FEMALE:childhood_total_dry_days_std +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_far <- feols( FAR_RIGHT_VOTE ~ childhood_total_dry_days_std  + FEMALE + FEMALE:childhood_total_dry_days_std +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION +
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_cat <- feols( CATHOLIC ~ childhood_total_dry_days_std  + FEMALE + I(childhood_total_dry_days_std^2) +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN,
                           data = model_data, cluster = ~birth_prov_cluster)
...
# 1. No FE
lpm_nofe_std_rel <- feols( RELIGIOUS_PRACTICE ~ childhood_total_dry_days_std  + FEMALE + I(childhood_total_dry_days_std^2) +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_cou <- feols( COUPLE_CATHOLIC ~ childhood_total_dry_days_std  + FEMALE + I(childhood_total_dry_days_std^2) +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_par <- feols( PARTICIPATION ~ childhood_total_dry_days_std  + FEMALE + I(childhood_total_dry_days_std^2) +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_con <- feols( CONSERVATIVE_VOTE ~ childhood_total_dry_days_std  + FEMALE + I(childhood_total_dry_days_std^2) +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT + FATHER_CATHOLIC + MOTHER_CATHOLIC +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION + 
                             MOTHER_EMPLOYMENT,
...
# 1. No FE
lpm_nofe_std_far <- feols( FAR_RIGHT_VOTE ~ childhood_total_dry_days_std  + FEMALE + I(childhood_total_dry_days_std^2) +
                             FATHER_BORN_SPAIN + FATHER_EDUCATION + survey_year +
                             FATHER_EMPLOYMENT +
                             MOTHER_BORN_SPAIN + MOTHER_EDUCATION +
                             MOTHER_EMPLOYMENT,
